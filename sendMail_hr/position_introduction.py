...
#read file
filehandle = codecs.open('D:\\Ann\\user_info_position_introduction.txt','r','utf-8')
...
for person in list:
	...
	#attachment
	filepath = unicode('D:\\Ann\\'+position+'.docx','utf8') 
	# print filepath
	file = open(filepath, 'w').read()
	att = MIMEText(file, 'base64', 'utf-8') 
	att["Content-Type"] = 'application/octet-stream'
	#position = position.encode('utf-8')
	att["Content-Disposition"] = 'attachment; filename='+position+'.docx'
	print position
	msgRoot.attach(att)
